...
insert into Report_Columns(id, report_id, sql_name, business_name, is_business_key, is_used_for_compare) values
(2, 1, 'first_name', 'customer_first_name', 1, 1),
(3, 1, 'last_name' , 'customer_last_name', 1, 1),
(4, 1, 'age', 'customer_age', 0, 1) ;
